      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 pt-16 pb-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 pb-12 border-b border-[#1c1b19]">
          <div className="lg:col-span-6 flex flex-col justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <a href="mailto:raunakxshrivastva@gmail.com" className="px-4 py-2 border border-amber-500/80 bg-amber-500/10 text-amber-300 hover:bg-amber-500 hover:text-black transition-all text-xs font-bold uppercase tracking-wider rounded-xs flex items-center gap-2 shadow-lg">
                <span>✉️ SEND EMAIL</span>
              </a>
              <a href="/resume.pdf" download="Raunak_Shrivastva_Resume.pdf" target="_blank" rel="noopener noreferrer" className="px-4 py-2 border border-[#383633] bg-[#121110] text-[#ded8ce] hover:border-amber-400 hover:text-white transition-all text-xs font-bold uppercase tracking-wider rounded-xs flex items-center gap-2">
          ...
          <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-6 font-mono text-xs">
            <div className="p-4 border border-[#242320] bg-[#0c0c0b] rounded-xs">
              <div className="text-[10px] text-[#858077] uppercase tracking-widest mb-1.5">PRIMARY EMAIL</div>
              <a href="mailto:raunakxshrivastva@gmail.com" className="text-sm font-bold text-[#e3ded7] hover:text-amber-400 transition-colors break-all">raunakxshrivastva@gmail.com</a>
            </div>

            <div className="p-4 border border-[#242320] bg-[#0c0c0b] rounded-xs">
              <div className="text-[10px] text-[#858077] uppercase tracking-widest mb-1.5">GITHUB DOSSIER</div>
              <a href="https://github.com/raunakxshrivastva" target="_blank" rel="noreferrer" className="text-sm font-bold text-[#e3ded7] hover:text-amber-400 transition-colors truncate block">github.com/raunakxshrivastva</a>
            </div>

            <div className="p-4 border border-[#242320] bg-[#0c0c0b] rounded-xs">
              <div className="text-[10px] text-[#858077] uppercase tracking-widest mb-1.5">LINKEDIN NETWORK</div>
              <a href="https://linkedin.com/in/raunakxshrivastva" target="_blank" rel="noreferrer" className="text-sm font-bold text-[#e3ded7] hover:text-amber-400 transition-colors truncate block">linkedin.com/in/raunakxshrivastva</a>
            </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-[10px] text-[#858077] tracking-wider uppercase">
          ...
          <div className="flex items-center gap-4">
            <span>COLLEGE ASSIGNMENT PORTFOLIO</span>
            <span>▪</span>
